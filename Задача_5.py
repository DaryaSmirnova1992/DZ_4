...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("file_task_5.1.txt", create_str(koef1))
write_file("file_task_5.2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('file_task_5.1.txt', 'r') as data:
    st1 = data.readlines()
with open('file_task_5.2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("file_Task5_res.txt", create_str(lst_new))
with open('file_Task5_res.txt', 'r') as data:
    st3 = data.readlines()
